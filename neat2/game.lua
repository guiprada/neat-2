...
function game.load(window, width, height)
	...
	local circle_texture = window:new_texture("assets/square_32.bmp")	
	game.circle = window:new_sprite(circle_texture)
	...
	local rectangle_texture2 = window:new_texture("assets/rectangle2.png")
	game.rectangle2 =window:new_sprite(rectangle_texture2)
...
function  game.render(window)
	game.circle:render()
	window:rect_fill(125,250,128,128, neat.color.red)
